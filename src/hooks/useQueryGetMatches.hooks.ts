...
useQueryGetMatches.fetcher = (matchList, uri = ''): IUseQueryGetMatches[] => matchList.map((matchId) => RiotAPIAsia.get(`${uri}/match/v5/matches/${matchId}`));
interface IUseQueryGetMatches {
  metadata: Metadata;
  info: Info;
}
